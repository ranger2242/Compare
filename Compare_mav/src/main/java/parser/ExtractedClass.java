...
public class ExtractedClass {
    ...
    private ArrayList<java.lang.Enum> enums = new ArrayList<>();
    ...
    private ArrayList<java.lang.Enum> findEnum(ClassOrInterfaceDeclaration cid) {
        ArrayList<java.lang.Enum> e = new ArrayList<>();
        List<EnumDeclaration> d = cid.getChildNodesByType(EnumDeclaration.class);
       // d.forEach(x -> e.add(new java.lang.Enum(x)));
        return e;
    }
    ...
    public void setEnums(ArrayList<java.lang.Enum> enums) {
        this.enums = enums;
    }
