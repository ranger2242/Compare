...
public class Parser {
    ...
    private final ArrayList<java.lang.Enum> globalEnums = new ArrayList<>();
     ...
     */
    public static ProjectData<Set<ExtractedClass>, Set<java.lang.Enum>> parseProject(ExtractedDirectory[] directories) {
        Set<ExtractedClass> classes = new LinkedHashSet<>();
        Set<java.lang.Enum> globalEnums = new LinkedHashSet<>();
        ProjectData<Set<ExtractedClass>, Set<java.lang.Enum>> projectData = new ProjectData<>(classes, globalEnums);

        for (ExtractedDirectory directory : directories) {
            ProjectData<Set<ExtractedClass>, Set<java.lang.Enum>> directoryData = parseClientDirectory(directory);
    ...
    public static ProjectData<ArrayList<Set<ExtractedClass>>, ArrayList<Set<java.lang.Enum>>> parseDirectories(ArrayList<ExtractedDirectory> directories) {
        ArrayList<Set<ExtractedClass>> parsedClasses = new ArrayList<>();
        ArrayList<Set<java.lang.Enum>> globalEnums = new ArrayList<>();
    ...
    private static ProjectData<Set<ExtractedClass>, Set<java.lang.Enum>> parseClientDirectory(ExtractedDirectory directory) {
        /*
        *  ArrayList<Set<ExtractedClass>> parsedClasses = new ArrayList<>();
    ...
    private ArrayList<ExtractedClass> parseCode(String dir) {
        ...
        for (TypeDeclaration<?> cl : classes) {
            ...
            if (cl.isEnumDeclaration()) {
                // globalEnums.add(new java.lang.Enum(cl.asEnumDeclaration()));
    ...
    private ArrayList<java.lang.Enum> getGlobalEnums() {
        return globalEnums;
    }
